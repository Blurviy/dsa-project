...
public isolated client class OnlineshopServiceOrderResponseCaller {
...
public isolated client class OnlineshopServiceUsersResponseCaller {
    private final grpc:Caller caller;
...
public isolated client class OnlineshopServiceProductListResponseCaller {
    private final grpc:Caller caller;
...
public isolated client class OnlineshopServiceCartResponseCaller {
    private final grpc:Caller caller;
...
public isolated client class OnlineshopServiceProductResponseCaller {
    private final grpc:Caller caller;
